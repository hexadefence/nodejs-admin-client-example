            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        requestConfig = __assign(__assign({ paramsSerializer: function (params) { return query_string_1["default"].stringify(params); } }, (this.client.getRequestConfig() || {})), { method: method,
                            url: url });
                        _b = requestConfig;
